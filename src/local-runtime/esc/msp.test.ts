...
// Run directly: tsx src/local-runtime/esc/msp.test.ts
...
// Response framing probe: needs a full `$M>` frame.
{
  ...
  assert.equal(mspFrameLength(Uint8Array.of(0x24, 0x4d, 0x3e, 0x03)), null)
  assert.equal(mspFrameLength(Uint8Array.of(0xfe, 0x09, 0x00)), null)
  assert.equal(
    mspFrameLength(Uint8Array.of(0xfe, 0x09, 0x24, 0x4d, 0x3c, 0x00, 0x01, 0x01, 0x24, 0x4d, 0x3e, 0x00, 0x01, 0x01)),
    14,
