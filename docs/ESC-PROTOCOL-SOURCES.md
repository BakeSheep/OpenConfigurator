...
| ArduPilot 前置条件：`SERVO_BLH_AUTO/MASK`、DShot、USB | [ArduPilot BLHeli passthrough 文档](https://ardupilot.org/copter/docs/common-blheli32-passthru.html) | UI 与 Worker 会话门控 |
